        // ==========================================
        // 1. DATEN FÜR SCHWANGERSCHAFT (OBST/GEMÜSE)
        // ==========================================
        const sswFruitData = {
            4: { fruit: "ein Mohnsamen", emoji: "🌱" },
            5: { fruit: "ein Apfelkern", emoji: "🍎" },
            6: { fruit: "ein Linsenkorn", emoji: "🫘" },
            7: { fruit: "eine Blaubeere", emoji: "🫐" },
            8: { fruit: "eine Himbeere", emoji: "🍓" },
            9: { fruit: "eine Weintraube", emoji: "🍇" },
            10: { fruit: "eine Pflaume", emoji: "🫐" },
            11: { fruit: "eine Erdbeere", emoji: "🍓" },
            12: { fruit: "eine Limette", emoji: "🍋" },
            13: { fruit: "eine Zitrone", emoji: "🍋" },
            14: { fruit: "eine Nektarine", emoji: "🍑" },
            15: { fruit: "ein Apfel", emoji: "🍎" },
            16: { fruit: "eine Avocado", emoji: "🥑" },
            17: { fruit: "eine Birne", emoji: "🍐" },
            18: { fruit: "eine Paprika", emoji: "🫑" },
            19: { fruit: "eine Mango", emoji: "🥭" },
            20: { fruit: "eine Banane", emoji: "🍌" },
            21: { fruit: "eine Karotte", emoji: "🥕" },
            22: { fruit: "eine Papaya", emoji: "🥭" },
            23: { fruit: "eine Aubergine", emoji: "🍆" },
            24: { fruit: "ein Maiskolben", emoji: "🌽" },
            25: { fruit: "ein Blumenkohl", emoji: "🥦" },
            26: { fruit: "eine Zucchini", emoji: "🥒" },
            27: { fruit: "ein Brokkoli", emoji: "🥦" },
            28: { fruit: "ein Hokkaido-Kürbis", emoji: "🎃" },
            29: { fruit: "ein Butternut-Kürbis", emoji: "🎃" },
            30: { fruit: "eine Ananas", emoji: "🍍" },
            31: { fruit: "ein Chinakohl", emoji: "🥬" },
            32: { fruit: "eine Kokosnuss", emoji: "🥥" },
            33: { fruit: "ein Sellerie", emoji: "🥬" },
            34: { fruit: "eine Honigmelone", emoji: "🍈" },
            35: { fruit: "eine Netzmelone", emoji: "🍈" },
            36: { fruit: "ein Romana-Salat", emoji: "🥬" },
            37: { fruit: "ein Mangold", emoji: "🥬" },
            38: { fruit: "ein Rhabarber", emoji: "🌱" },
            39: { fruit: "eine Wassermelone", emoji: "🍉" },
            40: { fruit: "ein großer Kürbis", emoji: "🎃" }
        };

        // ==========================================
        // 1.b DATEN FÜR SCHWANGERSCHAFT (TIERE)
        // ==========================================
        const sswAnimalData = {
            4: { animal: "ein Wasserfloh", emoji: "🦠" },
            5: { animal: "eine Ameise", emoji: "🐜" },
            6: { animal: "eine Fliege", emoji: "🪰" },
            7: { animal: "eine Biene", emoji: "🐝" },
            8: { animal: "ein Schmetterling", emoji: "🦋" },
            9: { animal: "ein Skarabäus", emoji: "🪲" },
            10: { animal: "ein Frosch", emoji: "🐸" },
            11: { animal: "ein Kolibri", emoji: "🐦" },
            12: { animal: "eine Maus", emoji: "🐁" },
            13: { animal: "ein kleiner Fisch", emoji: "🐟" },
            14: { animal: "eine Zwergfledermaus", emoji: "🦇" },
            15: { animal: "ein Eichhörnchen", emoji: "🐿️" },
            16: { animal: "ein Hamster", emoji: "🐹" },
            17: { animal: "eine Ratte", emoji: "🐀" },
            18: { animal: "ein Igel", emoji: "🦔" },
            19: { animal: "ein Meerschweinchen", emoji: "🐹" },
            20: { animal: "ein Papagei", emoji: "🦜" },
            21: { animal: "ein Chinchilla", emoji: "🐁" },
            22: { animal: "ein Opossum", emoji: "🐭" },
            23: { animal: "ein Kaninchen", emoji: "🐇" },
            24: { animal: "ein Frettchen", emoji: "🦦" },
            25: { animal: "eine Taube", emoji: "🕊️" },
            26: { animal: "ein Rebhuhn", emoji: "🐦" },
            27: { animal: "ein Welpe", emoji: "🐶" },
            28: { animal: "ein kleines Kätzchen", emoji: "🐱" },
            29: { animal: "ein Erdmännchen", emoji: "🦦" },
            30: { animal: "ein Schnabeltier", emoji: "🦆" },
            31: { animal: "ein Koala-Baby", emoji: "🐨" },
            32: { animal: "ein kleiner Fuchs", emoji: "🦊" },
            33: { animal: "ein Waschbär-Baby", emoji: "🦝" },
            34: { animal: "ein Pinguin", emoji: "🐧" },
            35: { animal: "ein Zwergpudel", emoji: "🐩" },
            36: { animal: "ein Faultier-Baby", emoji: "🦥" },
            37: { animal: "ein Biber", emoji: "🦫" },
            38: { animal: "ein Katzenjunges", emoji: "🐈" },
            39: { animal: "ein Schwan", emoji: "🦢" },
        ...
        try {
            ...
            if (savedAssignedRoles) {
                assignedRoles = savedAssignedRoles;
            }
        ...
        function ensureOvulationPoint(childIndex, birthDate) {
            ...
            if (!hasZeroPoint) {
                ...
                growthData[childIndex].forEach(item => {
                    if (Number(item.size) === 0 && Number(item.weight) === 0) {
                        item.date = ovulationDateStr;
                    }
                });
            }
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (profileHeaderName) {
                profileHeaderName.innerText = `Profil (${currentUserRole.split(' ')[0]})`;
            }

            let settingNotif = document.getElementById('settingNotif');
            if (settingNotif) {
                settingNotif.checked = appSettings.notif;
            }

            let settingPregShare = document.getElementById('settingPregShare');
            if (settingPregShare) {
                settingPregShare.checked = appSettings.pregShare;
            }
            ...
            kids.forEach((kid, idx) => {
                if (!kid) return; // FIX: Verhindert Absturz bei fehlerhaften Speichereinträgen!
                
                if (kid.birthDate && kid.dateType && kid.dateType.toLowerCase() === 'et') {
                    ensureOvulationPoint(idx, kid.birthDate);
                }
                if (kid.birthDate && isChildBorn(kid) && (kid.size || kid.weight)) {
                    ensureInitialGrowthEntry(idx, kid.birthDate, kid.size, kid.weight);
                }
            });
        ...
        function updateDateLabel() {
            ...
            if (type === 'et') {
                label.innerText = "Errechneter Geburtstermin (ET)";
            } else {
                label.innerText = "Tatsächlicher Geburtstag";
            }
        }
        ...
        function updateRoleSelectOptions() {
            ...
            if (assignedRoles.mama && assignedRoles.mama !== currentUserRole) {
                mamaOpt.disabled = true;
                mamaOpt.innerText = "Mama 👩 (Bereits vergeben)";
            } else {
                mamaOpt.disabled = false;
                mamaOpt.innerText = "Mama 👩";
            }

            if (assignedRoles.papa && assignedRoles.papa !== currentUserRole) {
                papaOpt.disabled = true;
                papaOpt.innerText = "Papa 👨 (Bereits vergeben)";
            } else {
                papaOpt.disabled = false;
                papaOpt.innerText = "Papa 👨";
            }
        }
        ...
        function saveUserRole() {
            ...
            if (selectedVal.includes("Mama")) {
                if (assignedRoles.mama && assignedRoles.mama !== currentUserRole) {
                    alert("Diese Option ist bereits für Mama vergeben!");
                    roleSelect.value = currentUserRole;
                    return;
                }
                ...
                if (assignedRoles.papa && assignedRoles.papa !== currentUserRole) {
                    alert("Diese Option ist bereits für Papa vergeben!");
                    roleSelect.value = currentUserRole;
                    return;
                }
        ...
        function updatePregnancyNavVisibility() {
            ...
            if (isMomOrDad) {
                ...
                if (appSettings.pregShare) {
                    navItem.style.display = 'flex';
                } else {
                    navItem.style.display = 'none';
                    let pregScreen = document.getElementById('pregnancyScreen');
                    if (pregScreen && pregScreen.classList.contains('active')) {
                        showMainAppScreen();
                    }
                }
            }
        ...
        function openProfileSubpage(subpageId) {
            ...
            document.querySelectorAll('#profileScreen .subpage').forEach(page => {
                page.classList.remove('active');
            });
            document.getElementById(subpageId).classList.add('active');
            if (subpageId === 'authSubpage') {
                renderAuthStatus();
            }
        }
            ...
            if (isLoggedIn) {
                container.innerHTML = `
                    <div class="highlight-box">
                        🟢 Du bist aktuell angemeldet als <strong>${currentUserRole}</strong>.
                    </div>
                    <p style="font-size:0.9rem; color:var(--text-muted); margin-bottom:16px;">
                        Wenn du dich abmeldest, musst du dich beim nächsten Öffnen der App neu verifizieren.
                    </p>
                ...
                container.innerHTML = `
                    ...
                    <p style="font-size:0.9rem; color:var(--text-muted); margin-bottom:16px;">
                        Möchtest du dich wieder anmelden?
                    </p>
                    <button onclick="handleLogin()" class="btn">🔑 Wieder Anmelden</button>
                `;
            }
        }
        ...
        function submitContactForm() {
            let email = document.getElementById('contactUserEmail').value.trim();
            let msg = document.getElementById('contactUserMsg').value.trim();
            if (!email || !msg) {
                alert("Bitte fülle deine E-Mail-Adresse und deine Nachricht aus.");
                return;
            }
            alert(`Vielen Dank! Deine Nachricht wurde erfolgreich gesendet. Wir werden uns bald bei ${email} melden.`);
        ...
        function updateUnitLabels() {
            ...
            if (labelSizeBirth) {
                labelSizeBirth.innerText = `Größe bei Geburt (optional in ${appUnits.size})`;
            }

            let labelWeightBirth = document.getElementById('labelWeightBirth');
            if (labelWeightBirth) {
                labelWeightBirth.innerText = `Gewicht bei Geburt (optional in ${appUnits.weight})`;
            }

            let labelGrowthSize = document.getElementById('labelGrowthSize');
            if (labelGrowthSize) {
                labelGrowthSize.innerText = `Größe (${appUnits.size})`;
            }

            let labelGrowthWeight = document.getElementById('labelGrowthWeight');
            if (labelGrowthWeight) {
                labelGrowthWeight.innerText = `Gewicht (${appUnits.weight})`;
            }

            let labelPregSize = document.getElementById('labelPregSize');
            if (labelPregSize) {
                labelPregSize.innerText = `Größe des Babys im Bauch (${appUnits.size}, opt.)`;
            }

            let labelPregWeight = document.getElementById('labelPregWeight');
            if (labelPregWeight) {
                labelPregWeight.innerText = `Gewicht des Babys im Bauch (${appUnits.weight}, opt.)`;
            }
        }
        ...
        function calculateAgeString(birthDateStr) {
            ...
            if (diffDays < 365) {
                let months = Math.floor(diffDays / 30.44);
                return `${months} Monat(e) alt`;
            }
            let years = (diffDays / 365.25).toFixed(1);
            return `ca. ${years} Jahr(e) alt`;
        }
        ...
        function renderDashboard() {
            ...
            kids.forEach((kid, index) => {
                if (!kid) return; // Sicherheits-Check
        ...
        function onCalendarDayClick(day) {
            ...
            if (posts && posts.length > 0) {
                openViewPostModal(day, posts[posts.length - 1].childIndex, posts.length - 1);
            } else {
                openDayModal(day);
            }
        }
        ...
        function openDayModal(day, postIndexToEdit = null) {
            ...
            document.getElementById('modalDayTitle').innerText = editingPostIndex !== null ? `Beitrag bearbeiten (${day}. Tag)` : `Eintrag für den ${day}. Tag`;
            document.getElementById('savePostBtn').innerText = editingPostIndex !== null ? "Änderungen speichern" : "Speichern";
        ...
        function editCurrentViewPost() { 
            closeViewPostModal(); 
            openDayModal(selectedDayForModal, viewingPostIndex); 
        }
        ...
        function deleteCurrentViewPost() {
            if (confirm("Möchtest du diesen Beitrag wirklich löschen?")) {
                ...
                if (allPosts[selectedDayForModal].length === 0) {
                    delete allPosts[selectedDayForModal];
                }
        ...
        function deletePostFromModal(day, index) {
            if (confirm("Möchtest du diesen Eintrag wirklich löschen?")) {
                ...
                renderDashboard();
                renderSavedPostsForModal();
                if (!allPosts[day] || allPosts[day].length === 0) {
                    closeDayModal();
                }
            }
        }
        ...
        async function saveDayPost() {
            ...
            if (editingPostIndex !== null) {
                allPosts[selectedDayForModal][editingPostIndex] = postObj;
            } else {
            ...
            Object.keys(allPosts).forEach(day => {
                allPosts[day].forEach(post => {
                    ...
                    if (post.media) {
                        post.media.forEach(m => {
                            let src = (typeof m === 'string') ? m : m.url;
                            if ((typeof m === 'object' && m.type === 'video') || src.includes('video')) {
                                totalVideos++;
                            } else {
                                totalImages++;
                            }
        ...
        function initGrowthScreen() {
            ...
            kids.forEach((k, idx) => {
                if (isChildBorn(k)) {
                    bornKids.push({ kid: k, originalIndex: idx });
                }
            });
            ...
            if (document.getElementById('growthDateInput')) {
                document.getElementById('growthDateInput').valueAsDate = new Date();
            }
            resetGrowthForm();
            renderGrowthData();
        }
        ...
        function saveGrowthEntry() {
            ...
            if (childIndex === "" || childIndex === null || !kids[childIndex]) {
                alert("Bitte wähle ein gültiges Kind aus.");
                return;
            }
            ...
            if (!entry.date || (!entry.size && !entry.weight)) { 
            ...
            if (editingGrowthIndex !== null) {
                growthData[childIndex][editingGrowthIndex] = entry;
            } else {
                growthData[childIndex].push(entry);
            }
        ...
        function editGrowthEntry(index) {
            ...
            document.getElementById('growthFormButtons').innerHTML = `
                <button onclick="saveGrowthEntry()" class="btn">Aktualisieren</button>
                <button onclick="resetGrowthForm()" class="btn btn-secondary" style="margin-top:6px;">Abbrechen</button>
            `;
        }
        ...
        function renderGrowthChart(list, container, kid) {
            ...
            let maxValSize = 80;
            list.forEach(item => {
                if(Number(item.size) > maxValSize) maxValSize = Math.ceil(Number(item.size) / 10) * 10;
            });

            let maxValWeight = 20;
            list.forEach(item => {
                if(Number(item.weight) > maxValWeight) maxValWeight = Math.ceil(Number(item.weight) / 5) * 5;
            });
            ...
            for (let v = 0; v <= maxValSize; v += 10) {
                ...
                line.setAttribute("x2", width - pR); line.setAttribute("y2", y);
                line.setAttribute("stroke", "#e2e8f0"); line.setAttribute("stroke-dasharray", "3,3");
                svg.appendChild(line);

                let text = document.createElementNS("http://www.w3.org/2000/svg", "text");
                text.setAttribute("x", pL - 8); text.setAttribute("y", y + 4);
                text.setAttribute("font-size", "11"); text.setAttribute("fill", "#64748b"); text.setAttribute("text-anchor", "end");
            ...
            if (weightPoints.length > 1) {
                ...
                pathW.setAttribute("d", pathStrW);
                pathW.setAttribute("fill", "none");
                pathW.setAttribute("stroke", "#ef4444");
                pathW.setAttribute("stroke-width", "2.5");
            ...
            for (let w = 0; w <= maxValWeight; w += 5) {
                ...
                textW.setAttribute("x", x); textW.setAttribute("y", height - pB + 20);
                textW.setAttribute("font-size", "10"); textW.setAttribute("fill", "#ef4444"); textW.setAttribute("text-anchor", "middle");
                textW.textContent = w + "kg";
                svg.appendChild(textW);
                
                let lineW = document.createElementNS("http://www.w3.org/2000/svg", "line");
                lineW.setAttribute("x1", x); lineW.setAttribute("y1", pT);
                lineW.setAttribute("x2", x); lineW.setAttribute("y2", height - pB);
                lineW.setAttribute("stroke", "#f1f5f9"); lineW.setAttribute("stroke-dasharray", "2,2");
                svg.insertBefore(lineW, svg.firstChild);
            }

            // Punkte & Datumsangaben
            list.forEach(item => {
                ...
                if (item.weight && !isNaN(Number(item.weight))) {
                    ...
                    circleW.setAttribute("cx", x); circleW.setAttribute("cy", y); circleW.setAttribute("r", "4.5");
                    circleW.setAttribute("fill", "#ef4444");
                    svg.appendChild(circleW);
                }

                let dateText = document.createElementNS("http://www.w3.org/2000/svg", "text");
                dateText.setAttribute("x", x); dateText.setAttribute("y", height - pB + 35);
                dateText.setAttribute("font-size", "10"); dateText.setAttribute("fill", "#1e293b");
                dateText.setAttribute("text-anchor", "end");
                dateText.setAttribute("transform", `rotate(-35, ${x}, ${height - pB + 35})`);
        ...
        // ==========================================
        // SCHLAFTRACKER LOGIK (Live Tracker, Grafik)
        // ==========================================
        ...
        function saveSleepEntry() {
            ...
            if (!start) { 
                alert("Bitte mindestens die Einschlafzeit angeben."); 
                return; 
            }
            ...
            if (end) {
                ...
                if (endTime <= startTime) { 
                    alert("Die Aufwachzeit muss nach der Einschlafzeit liegen."); 
                    return; 
                }
            ...
            if (!sleepData[childIndex]) {
                sleepData[childIndex] = [];
            }
            
            if (editingSleepIndex !== null) {
                sleepData[childIndex][editingSleepIndex] = entry;
            } else {
                sleepData[childIndex].push(entry);
            }
        ...
        function editSleepEntry(index) {
            ...
            document.getElementById('sleepFormButtons').innerHTML = `
                <button onclick="saveSleepEntry()" class="btn">Aktualisieren</button>
                <button onclick="resetSleepForm()" class="btn btn-secondary" style="margin-top:6px;">Abbrechen</button>
            `;
        }
        ...
        function renderSleepData() {
            ...
            sleepData[childIndex].forEach((item, index) => {
                ...
                let durationText = item.isSleeping ? 
                    `<span style="color:var(--primary); font-weight:bold;">Schläft gerade... 😴</span>` : 
                    `Dauer: ${formatDuration(item.duration)}`;
                    
                let endText = item.isSleeping ? 
                    `<button onclick="wakeUpChild(${index})" style="margin-top:5px; padding:6px 10px; border-radius:6px; border:none; background:var(--primary); color:white; font-size:0.8rem; font-weight:bold; cursor:pointer;">Jetzt aufgewacht</button>` : 
                    `Aufgewacht: ${new Date(item.end).toLocaleString('de-DE', formatOpt)}`;
        ...
        // HIER WURDE DIE FUNKTION FÜR DAS NEUE CHART ERSETZT
        function renderSleepChart(list, container) {
            container.innerHTML = '';
            if (!list || list.length === 0) return;
            
            // 1. Nur Einträge von heute filtern
            let today = new Date();
            ...
            // Einträge umdrehen (älteste von heute links, neueste rechts)
            todayEntries = todayEntries.slice().reverse();

            // 2. Daten für das Diagramm aufbereiten (inkl. Live-Dauer)
            let chartData = todayEntries.map(item => {
                let durationMins = item.duration;
                // Wenn das Kind gerade schläft, berechnen wir die Live-Dauer bis JETZT für den Balken
                if (item.isSleeping) {
            ...
            if (maxMins === 0) maxMins = 60; // Standardwert, falls gerade erst eingeschlafen
            
            let maxHours = Math.ceil(maxMins / 60);
            maxHours = Math.max(maxHours, 2); // Mindestens 2 Stunden Skala für eine gute Optik

            // Y-Achse (Stunden-Linien)
            ...
            if (barWidth > 45) barWidth = 45; // Balken nicht zu dick machen
            ...
            chartData.forEach((data, i) => {
                ...
                // Ein Mindestmaß (z.B. 4px) setzen, damit man den Balken beim direkten Start schon sieht
                rect.setAttribute("height", Math.max(barHeight, 4)); 
                rect.setAttribute("fill", "var(--primary)");
                rect.setAttribute("rx", "4"); 
                
                // CSS Animationsklasse hinzufügen, wenn der Schlaf live ist
                if (data.isSleeping) {
                    rect.classList.add("sleep-active");
                }
                
                svg.appendChild(rect);

                // X-Achse: Uhrzeit (HH:MM) statt Datum
                let text = document.createElementNS("http://www.w3.org/2000/svg", "text");
                text.setAttribute("x", x + barWidth/2); 
                text.setAttribute("y", height - pB + 15);
                text.setAttribute("font-size", "10"); 
                text.setAttribute("fill", "#64748b"); 
        ...
        function initPregnancyScreen() {
            ...
            if (document.getElementById('pregDateInput')) {
                document.getElementById('pregDateInput').valueAsDate = new Date();
            }
        ...
        async function savePregnancyEntry() {
            ...
            let entry = {
                date: document.getElementById('pregDateInput').value,
                size: document.getElementById('pregSizeInput').value,
                weight: document.getElementById('pregWeightInput').value,
                note: document.getElementById('pregNoteInput').value,
                media: mediaArray
            };
            ...
            if (!pregnancyData[childIndex]) {
                pregnancyData[childIndex] = [];
            }

            if (editingPregIndex !== null) {
                pregnancyData[childIndex][editingPregIndex] = entry;
            } else {
                pregnancyData[childIndex].push(entry);
            }
        ...
        function renderPregnancyData() {
            ...
            list.forEach((item, index) => {
                ...
                div.innerHTML = `
                    ...
                    <div>
                        Größe: ${item.size ? item.size + ' ' + appUnits.size : '-'} | Gewicht: ${item.weight ? item.weight + ' ' + appUnits.weight : '-'}
                    </div>
        ...
        function editPregEntry(index) {
            ...
            document.getElementById('pregFormButtons').innerHTML = `
                <button onclick="savePregnancyEntry()" class="btn">Aktualisieren</button>
                <button onclick="resetPregnancyForm()" class="btn btn-secondary" style="margin-top:6px;">Abbrechen</button>
            `;
        }
        ...
        function resetWishForm() {
            ...
            if (btnContainer) {
                btnContainer.innerHTML = `<button onclick="saveWishItem()" class="btn">Wunsch hinzufügen</button>`;
            }
        ...
        function saveWishItem() {
            ...
            if (!title) { 
                alert("Bitte einen Wunsch eingeben."); 
                return; 
            }
            ...
            let item = {
                ...
                link: document.getElementById('wishLinkInput').value.trim(),
            ...
            if (!wishlistData[childIndex]) {
                wishlistData[childIndex] = [];
            }
            
            if (editingWishIndex !== null) {
                wishlistData[childIndex][editingWishIndex] = item;
            } else {
                wishlistData[childIndex].push(item);
            }
        ...
        function editWishItem(index) {
            ...
            if (btnContainer) {
                btnContainer.innerHTML = `
                    <button onclick="saveWishItem()" class="btn">Wunsch aktualisieren</button>
                    <button onclick="resetWishForm()" class="btn btn-secondary" style="margin-top:6px;">Abbrechen</button>
                `;
            }
        }
        ...
        function renderWishlist() {
            ...
            list.forEach((item, index) => {
                let div = document.createElement('div');
                div.style.cssText = `background:#f1f5f9; padding:12px; border-radius:10px; font-size:0.85rem; display:flex; justify-content:space-between; align-items:center; ${item.done ? 'opacity:0.6;' : ''}`;
                
                let linkHtml = item.link ? `<a href="${item.link}" target="_blank" style="color:var(--primary); text-decoration:none; display:block; margin-top:4px;">🔗 Produkt ansehen</a>` : '';
                ...
                div.innerHTML = `
                    <div style="flex-grow: 1;">
                        <div style="display:flex; align-items:center; gap:8px;">
                            <input type="checkbox" ${item.done ? 'checked' : ''} onchange="toggleWishItem(${index})" style="width:16px; height:16px; accent-color:var(--primary);">
        ...
        function shareAppViaWhatsApp(code) {
            let text = encodeURIComponent(`Schau dir unbedingt unsere BabySteps-App an! Nutze bei der Anmeldung meinen Link und wir bekommen beide 10% Rabatt! https://deine-app-domain.de/invite/${code}`);
        ...
        function sendWhatsAppInvite() {
            let text = encodeURIComponent("Schau dir unbedingt unsere BabySteps-App an und verfolge die Entwicklung unseres Babys! Die App ist für dich komplett kostenlos: [App-Link einfügen]");
